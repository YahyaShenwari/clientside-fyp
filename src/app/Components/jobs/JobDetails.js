              ...
              <PortletHeaderToolbar>
                <div>
                  {moment().isAfter(job.dueDate) ? (
                    <span className="btn btn-label-danger btn-sm btn-bold">
                      Expired
                    </span>
                  ) : (
                    <span className="btn btn-label-success btn-sm btn-bold">
                      Active
                    </span>
                  )}
                </div>
                <div>
                  {canApply(job, userId) && (
                    <span className="btn btn-label-success btn-sm btn-bold ml-3">
                      Applied
                    </span>
                  )}
                </div>
                {isUser && (
                  <button
                    className={`btn btn-${
                      moment().isAfter(job.dueDate) ? "danger" : "success"
                    } btn-sm ml-3`}
                    onClick={handleShow}
                    disabled={
                      moment().isAfter(job.dueDate) || canApply(job, userId)
                    }
                  >
                    Apply
                  </button>
            ...
            <div className="row">
              <div className="col-12 col-sm-6">
                ...
                <div className="d-flex justify-content-between mb-3">
                  ...
                  <Tooltip
                    title={moment(job.postedOn).calendar(null, {
